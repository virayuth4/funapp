  ...
  return (
    ...
    >
      <style jsx global>{`
        @keyframes pulseGlow {
          0%, 100% {
            box-shadow: 0 0 6px 0px var(--glow-color),
      ...
      <div
        className="relative w-full max-w-lg max-h-[85vh] flex flex-col bg-neutral-950 border border-neutral-800 rounded-xl shadow-2xl animate-in zoom-in-95 duration-150"
